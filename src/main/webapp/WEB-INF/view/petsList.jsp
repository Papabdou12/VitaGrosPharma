    ...
    <div class="content-table">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <th class="text-center">Date Of Birthday</th>
                <th class="text-center">PetType</th>
            ...
            <c:forEach var="p" items="${pets}">
                <tr>
                    <td class="text-center"><c:out value="${p.id}" /></td>
                    <td class="text-center"><c:out value="${p.name}" /></td>
                    <td class="text-center"><c:out value="${p.dateOfBirth}" /></td>
                <c:forEach var="pt" items="${petTypes}">
                    <td class="text-center"><c:out value="${pt.name}" /></td>
                </c:forEach>
                    <c:forEach var="v" items="${visits}">
                        <td class="text-center"><c:out value="${v.description}" /></td>
                    </c:forEach>
